...
public class MBNScaffoldingBlock extends ScaffoldingBlock implements IWaterLoggable {

    public MBNScaffoldingBlock(AbstractBlock.Properties properties) {
        super(properties);
    }
    ...
    public static int calculateDISTANCE(IBlockReader blockReader, BlockPos pos) {
        ...
        int i = 7;
        if (blockstate.getBlock() == MBNBlocks.VERDE_SCAFFOLDING.get()) {
        ...
        for (Direction direction : Direction.Plane.HORIZONTAL) {
            ...
            if (blockstate1.getBlock() == MBNBlocks.VERDE_SCAFFOLDING.get()) {
