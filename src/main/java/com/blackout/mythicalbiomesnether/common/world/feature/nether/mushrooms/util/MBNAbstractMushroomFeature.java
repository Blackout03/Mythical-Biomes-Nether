...
import com.blackout.mythicalbiomesnether.common.world.feature.FeatureUtil;
...
public abstract class MBNAbstractMushroomFeature<T extends MBNMushroomConfig> extends Feature<T> {

    public MBNAbstractMushroomFeature(Codec<T> configCodec) {
        super(configCodec);
    }
     ...
     */
    public static boolean isDesiredGroundwDirtTag(MBNMushroomConfig config, IWorldGenerationBaseReader reader, BlockPos pos, Block... desiredGroundBlock) {
    ...
    public static boolean isDesiredGroundwEndTags(MBNMushroomConfig config, IWorldGenerationBaseReader reader, BlockPos pos, Block... desiredGroundBlock) {
        if (config.isPlacementForced())
            return true;
