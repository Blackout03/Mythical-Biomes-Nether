package com.blackout.mythicalbiomesnether.common.world.util;
...
public class SurfaceContext {
    ...
    public static void push(ServerWorld world, IChunk chunk) {
        if (chunk instanceof ChunkPrimer) {
            ...
            MythicalBiomesNether.LOGGER.error("ERROR: Attempted to push invalid IChunk implementation to SurfaceContext: {}", chunk.getClass());
        }
    }
}
