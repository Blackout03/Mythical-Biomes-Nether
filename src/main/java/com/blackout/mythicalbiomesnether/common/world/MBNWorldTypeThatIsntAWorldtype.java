package com.blackout.mythicalbiomesnether.common.world;
...
public class MBNWorldTypeThatIsntAWorldtype extends ForgeWorldType {
    public MBNWorldTypeThatIsntAWorldtype() {
        super(null);
    }
    ...
    public static SimpleRegistry<Dimension> getDefaultSimpleRegistry(Registry<DimensionType> lookUpRegistryDimensionType, Registry<Biome> registry, Registry<DimensionSettings> dimensionSettings, long seed) {
        ...
        simpleregistry.register(Dimension.OVERWORLD, new Dimension(() -> lookUpRegistryDimensionType.getOrThrow(DimensionType.OVERWORLD_LOCATION), new NoiseChunkGenerator(new MBNNetherBiomeSource(registry, seed), seed, () -> dimensionSettings.getOrThrow(DimensionSettings.OVERWORLD))), Lifecycle.stable());

        simpleregistry.register(Dimension.NETHER, new Dimension(() -> lookUpRegistryDimensionType.getOrThrow(DimensionType.NETHER_LOCATION), new NoiseChunkGenerator(new MBNNetherBiomeSource(registry, seed), seed, () -> dimensionSettings.getOrThrow(DimensionSettings.NETHER))), Lifecycle.stable());
