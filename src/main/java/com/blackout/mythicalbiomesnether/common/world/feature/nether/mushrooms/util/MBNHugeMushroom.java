...
public abstract class MBNHugeMushroom {
    @Nullable
    protected abstract ConfiguredFeature<MBNMushroomConfig, ?> getHugeMushroomFeature(Random random);
    ...
    public boolean withSpawner(ISeedReader worldIn, ChunkGenerator chunkGenerator, BlockPos pos, BlockState blockUnder, Random random) {
        ConfiguredFeature<MBNMushroomConfig, ?> abstractMushroomFeature = this.getHugeMushroomFeature(random);
    ...
    public static abstract class Massive extends MBNHugeMushroom {
        ...
        @Nullable
        protected abstract ConfiguredFeature<MBNMushroomConfig, ?> getMassiveMushroomFeature(Random random);
        ...
        public boolean massiveMushroom(ISeedReader worldIn, ChunkGenerator chunkGenerator, BlockPos pos, BlockState blockUnder, Random random, int xOffset, int zOffset) {
            ConfiguredFeature<MBNMushroomConfig, ?> abstractMushroomFeature = this.getMassiveMushroomFeature(random);
            if (abstractMushroomFeature == null) {
                return false;
            } else {
