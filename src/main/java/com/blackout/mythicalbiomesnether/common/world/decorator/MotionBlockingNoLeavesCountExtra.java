...
public class MotionBlockingNoLeavesCountExtra extends Placement<AtSurfaceWithExtraConfig> {

    public MotionBlockingNoLeavesCountExtra(Codec<AtSurfaceWithExtraConfig> config) {
        super(config);
    }
